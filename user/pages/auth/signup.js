                ...
                <div className="row">
                    <div className="col-6 text-center">
                        ...
                        <form onSubmit={onSubmit}>
                            ...
                            {errors}
                            <button className="form-submit sub-but" type="submit">Register</button>
                        </form>
                    </div>
                    <div className="col-6 text-end">
                        <img src="https://colorlib.com/etc/regform/colorlib-regform-7/images/signup-image.jpg" height="315px" alt="signup image" />
                    </div>
                </div>
            </div>
        </div>
